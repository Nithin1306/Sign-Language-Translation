...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model('C:/Users/Nithin/Desktop/Sign-Language-To-Text-and-Speech-Conversion/cnn8grps_rad1_model.h5')
        ...
        self.b5 = tk.Button(self.root)
        self.b5.place(x=1190, y=700)

        self.b6 = tk.Button(self.root)
        self.b6.place(x=1390, y=700)
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread("C:\\Users\\Nithin\\Desktop\\Sign-Language-To-Text-and-Speech-Conversion\\white.jpg")
                ...
                if handz:
                    ...
                    self.b5.config(text=self.word5, font=("Courier", 20), wraplength=825, command=self.action5)
                    self.b6.config(text=self.word6, font=("Courier", 20), wraplength=825, command=self.action6)
    ...
    def action5(self):
        ...
        last_idx = len(self.str)
        self.str = self.str[:idx_word]
        self.str = self.str + self.word5.upper()
    ...
    def action6(self):
        ...
        last_idx = len(self.str)
        self.str = self.str[:idx_word]
        self.str = self.str + self.word6.upper()
    ...
    # Function to generate words using n-grams
    def generate_words(ngrams, n, num_words):
        words = []
        for _ in range(num_words):
            start = random.randint(0, len(ngrams) - n)
            word = ' '.join(ngrams[start])
            words.append(word)
        return words
    ...
    def predict(self, test_image):
        ...
        if len(self.str.strip()) != 0:
            ...
            if len(word.strip()) != 0:
                ...
                if lenn >= 3:
                    self.word6 = ddd.suggest(word)[5]

                if lenn >= 3:
                    self.word5 = ddd.suggest(word)[4]
